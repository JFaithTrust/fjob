...
function SocialButtonTg({link, title} : SocialButtonProps) {
  ...
  >
    <Link to={link || ""} className={"flex flex-row gap-x-2.5"}>
      <svg
          width="25"
          height="24"
          viewBox="0 0 25 24"
              ...
              <div className="flex flex-col gap-y-1">
                ...
                <div className="flex sm:flex-row flex-col sm:gap-x-16 gap-x-0 sm:gap-y-0 gap-y-2">
                  <Button
                      className="sm:w-fit w-full text-blue-400 bg-white px-5 py-1 border-blue-400 hover:bg-blue-400 border-2 border-solid rounded-md hover:text-white"
                  >
                    <Link to={`https://t.me/${job?.tgUserName}`} className={"flex flex-row gap-x-2.5"}>
                      <svg
                          width="25"
                          height="24"
                          viewBox="0 0 25 24"
                  ...
                  >
                    <Link to={`tel:${job?.phoneNumber}`} className={'flex flex-row gap-x-2.5'}>
                      <svg
                          width="25"
                          height="24"
                          viewBox="0 0 25 24"
