            ...
            <div className="flex flex-col pt-3 gap-y-3">
              ...
              <div className="flex flex-col gap-y-1">
                ...
                <div className="flex flex-row gap-x-16">
                  <Button
                    onClick={() => navigate(worker?.telegramLink || "")}
                    className="text-blue-400 w-fit bg-white flex flex-row gap-x-2.5 px-5 py-1 border-blue-400 hover:bg-blue-400 border-2 border-solid rounded-md hover:text-white"
                  >
                    <svg
                      width="25"
                      height="24"
                  ...
                  <Button
                    onClick={() => navigate(worker?.instagramLink || "")}
                    className="text-red-400 w-fit bg-white flex flex-row gap-x-2.5 px-5 py-1 border-red-400 hover:bg-red-400 border-2 border-solid rounded-md hover:text-white"
                  >
                    <svg
                      width="25"
                      height="24"
              ...
              <div className="flex flex-col gap-y-1">
                ...
                <div className="flex flex-row gap-x-16">
                  <Button
                    onClick={() => navigate(worker?.tgUsername || "")}
                    className="text-blue-400 w-fit bg-white flex flex-row gap-x-2.5 px-5 py-1 border-blue-400 hover:bg-blue-400 border-2 border-solid rounded-md hover:text-white"
                  >
                    <svg
                      width="25"
                  ...
                  <Button
                    onClick={() => navigate(worker?.phoneNumber || "")}
                    className="text-green-400 w-fit bg-white flex flex-row gap-x-2.5 px-5 py-1 border-green-400 hover:bg-green-400 border-2 border-solid rounded-md hover:text-white"
                  >
                    <svg
                      width="25"
                      height="24"
